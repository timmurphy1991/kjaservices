...
document.querySelectorAll(".accent").forEach(accent=>accentObserver.observe(accent));

/*---SCROLL_ARROW✅---*/

const a=document.querySelector(".scroll-arrow"),s=document.querySelector(".banner-video+section");
if(a&&s){
a.onclick=()=>s.scrollIntoView({behavior:"smooth"});
const t=()=>{a.style.opacity=scrollY>60?0:1;a.style.pointerEvents=scrollY>60?"none":"auto";};
